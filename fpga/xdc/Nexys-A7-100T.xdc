...
##Pmod Headers
##Pmod Header JA
set_property -dict {PACKAGE_PIN C17 IOSTANDARD LVCMOS33} [get_ports JA_PMOD_CS]
set_property -dict {PACKAGE_PIN D18 IOSTANDARD LVCMOS33} [get_ports JA_PMOD_MOSI]
#set_property -dict{ PACKAGE_PIN E18   IOSTANDARD LVCMOS33 } [get_ports { JA[3]         }];  #IO_L21P_T3_DQS_15 Sch=ja[3]
set_property -dict {PACKAGE_PIN G17 IOSTANDARD LVCMOS33} [get_ports JA_PMOD_SCK]
set_property -dict {PACKAGE_PIN D17 IOSTANDARD LVCMOS33} [get_ports JA_PMOD_DC]
set_property -dict {PACKAGE_PIN E17 IOSTANDARD LVCMOS33} [get_ports JA_PMOD_RES]
set_property -dict {PACKAGE_PIN F18 IOSTANDARD LVCMOS33} [get_ports JA_PMOD_VCCEN]
set_property -dict {PACKAGE_PIN G18 IOSTANDARD LVCMOS33} [get_ports JA_PMOD_EN]
