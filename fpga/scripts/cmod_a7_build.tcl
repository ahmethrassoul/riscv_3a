...
set project_name "riscv_soc_cmod_a7"
...
# automatically.
set top_module "riscv_soc_cmod_a7"
...
set top_sim_module "riscv_soc_cmod_a7_tb"
...
read_vhdl -vhdl2008 ../src/riscv_soc_cmod_a7.vhd
...
import_ip -files { ./xilinx_IPs/cmod_a7/clk_wiz_0.xci }
generate_target all [get_files clk_wiz_0.xci]

#set_property  ip_repo_paths  {../hls/halley_vitis_hls/cmod_a7/impl/ip} [current_project]
#update_ip_catalog -rebuild
#create_ip -name doCore -vendor xilinx.com -library hls -version 1.0 -module_name doCore_0
#generate_target {instantiation_template} [get_files ./proj/halley_xpr.srcs/sources_1/ip/doCore_0_1/doCore_0.xci]
#generate_target all [get_files  ./proj/halley_xpr.srcs/sources_1/ip/doCore_0_1/doCore_0.xci]
